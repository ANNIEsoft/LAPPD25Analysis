...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  for (int i = 0; i < 9; i++)
    {
      PlotMaker >> AmpParam[i] >> TimeParam[i];
   ...
   ofstream ParamOutput (outfilename + ".par");
   ParamOutput << "//FileName:" << endl;
   ParamOutput << outfilename << endl;
   ParamOutput << AmpFitFunc->GetParameter(0) << "\t" << TimeFitFunc->GetParameter(0)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(1) << "\t" << TimeFitFunc->GetParameter(1)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(2) << "\t" << TimeFitFunc->GetParameter(2)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(3) << "\t" << TimeFitFunc->GetParameter(3)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(4) << "\t" << TimeFitFunc->GetParameter(4)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(5) << "\t" << TimeFitFunc->GetParameter(5)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(6) << "\t" << TimeFitFunc->GetParameter(6)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(7) << "\t" << TimeFitFunc->GetParameter(7)  << endl;
   ParamOutput << AmpFitFunc->GetParameter(8) << "\t" << TimeFitFunc->GetParameter(8)  << endl;
}
